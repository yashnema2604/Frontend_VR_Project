...
const SuggestionVideoContainer = () => {
  ...
  const maxRelatedVideos = 0; // Maximum number of related videos to display
  ...
  const getVideos = async () => {
    ...
    // Limit the related videos based on maxRelatedVideos
    setRelatedVideos(json.items.slice(0, maxRelatedVideos));
  };
